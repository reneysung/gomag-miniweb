...
(function(){
  ...
  var idx=0;
  function show(i){idx=(i+urls.length)%urls.length;img.src=urls[idx];counter.textContent=(idx+1)+' / '+urls.length;overlay.classList.add('open');document.body.style.overflow='hidden';}
