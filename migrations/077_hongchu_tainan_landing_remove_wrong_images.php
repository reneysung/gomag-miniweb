<?php
// ============================================================
// Migration 077 — tainan landing 拿掉 4 張無關菜色照
// ------------------------------------------------------------
// Reney 對稿：「每個標題跟內容，配的圖片都不是有關係的」
// 原本 4 段配菜色照（sashimi/lobster/risotto/truffle-shrimp），
// 但段落主題是品牌引言/阿男師人像/服務範圍/為什麼選洪廚 — 配菜色不對。
//
// 解法：全部拿掉、純文字。等 Reney 給對的圖（店面/阿男師/場景）再加回。
//
// 跑法：HTTP_HOST=www.gomag.com.tw php migrations/077_hongchu_tainan_landing_remove_wrong_images.php
// ============================================================
...
echo "✅ tainan landing：4 張無關菜色照全拿掉，純文字\n";
echo "   等 Reney 給對的圖（店面/阿男師/場景）再加回\n";
